...
from .views import (
    ClientDashboardView,
    ClientRefreshStatusView,
    ClientRefreshView,
    Control5RouteDetailView,
    ControlReportView,
    DashboardHomeView,
    DrilldownView,
)
...
urlpatterns = [
    ...
    path("clients/<slug:slug>/controls/5/route-detail/", Control5RouteDetailView.as_view(), name="control_5_route_detail"),
